...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="w-full border-gray-200 bg-primary px-2 py-2.5 sm:px-4">
      <div className="container mx-auto flex flex-wrap items-center justify-between">
        ...
        <div
          ...
          id="navbar-default"
        >
          <ul className="mt-4 flex flex-col rounded-lg border border-accent bg-primary px-4 py-2 md:mt-0 md:flex-row md:items-center md:space-x-8 md:border-0 md:text-sm md:font-medium">
